  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE \`boleto\` (
        ...
        \`status\` enum('Failure', 'Processing', 'Pending', 'Approved', 'Paid', 'Expired', 'Cancelled', 'Overdue', 'Registered') NOT NULL DEFAULT 'Pending' COMMENT 'Status atual do boleto',
        ...
        \`our_number\` varchar(50) NULL COMMENT 'Número do nosso número do boleto',
        \`payments\` json NULL COMMENT 'Array de pagamentos do boleto recebido do Hiperbanco (pode ser null por muito tempo)',
