...
export class CreateBoletoDto implements ICreateBoleto {
  @ApiPropertyOptional({
    ...
    example: 'Teste emissão de boleto',
  })
  @IsOptional()
  @IsString()
  alias?: string;
  ...
  @ApiProperty({
    type: AccountDto,
    description: 'Informações da conta do beneficiário',
  })
  @ValidateNested()
  @Type(() => AccountDto)
  account: AccountDto;
  ...
  @ApiProperty({
    description: 'Número do documento (CPF ou CNPJ) do beneficiário final',
    example: '50300633859100',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiPropertyOptional({
    description:
      'Data limite para pagamento após vencimento (formato yyyy-MM-dd)',
    example: '2025-11-20',
  })
  @IsOptional()
  @IsDateString()
  ...
  @ApiPropertyOptional({
    type: PayerDto,
    description: 'Informações do pagador (obrigatório para tipo Levy)',
  })
  @IsOptional()
  @ValidateNested()
  @Type(() => PayerDto)
  ...
  @ApiPropertyOptional({
    type: InterestDto,
    description: 'Informações sobre juros (apenas para tipo Levy)',
  })
  @IsOptional()
  @ValidateNested()
  @Type(() => InterestDto)
  ...
  @ApiPropertyOptional({
    type: FineDto,
    description: 'Informações sobre multa (apenas para tipo Levy)',
  })
  @IsOptional()
  @ValidateNested()
  @Type(() => FineDto)
  ...
  @ApiPropertyOptional({
    type: DiscountDto,
    description: 'Informações sobre desconto (apenas para tipo Levy)',
  })
  @IsOptional()
  @ValidateNested()
  @Type(() => DiscountDto)
