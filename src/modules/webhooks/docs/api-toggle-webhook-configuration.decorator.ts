...
export function ApiToggleWebhookConfiguration() {
  return applyDecorators(
    ApiExtraModels(ErrorResponseDto),
    ApiOperation({
      summary: 'Ativar / desativar configuração de webhook',
      description:
        'Alterna o campo `isActive` da configuração. ' +
        'Quando `isActive = false`, nenhum novo evento é despachado para esta configuração. ' +
    ...
    ApiResponse({
      ...
      schema: {
        ...
        properties: {
          ...
          isActive: { type: 'boolean', example: false, description: 'Valor após a alternância' },
