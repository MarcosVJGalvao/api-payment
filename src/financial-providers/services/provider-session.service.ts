...
export class ProviderSessionService {
    ...
    async createSession(data: Omit<ProviderSession, 'sessionId' | 'createdAt' | 'expiresAt'>): Promise<ProviderSession> {
        ...
        this.logger.log(`Session created: ${sessionId} for ${data.providerSlug}`, this.context);
        return session;
    }
