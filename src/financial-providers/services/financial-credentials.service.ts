...
export class FinancialCredentialsService {
    ...
    async saveCredentials(
        ...
        this.logger.log(`Saving credentials for provider: ${provider}, loginType: ${dto.loginType}, clientId: ${clientId}`, this.context);
        ...
        if (!credential) {
            ...
            this.logger.log(`Creating new credential entry for ${provider} with loginType: ${dto.loginType}, clientId: ${clientId}`, this.context);
        } else {
        ...
        this.logger.log(`Credentials saved for provider: ${provider}, loginType: ${dto.loginType}, clientId: ${clientId}`, this.context);
        return saved;
    }
    ...
    async getDecryptedCredentials(
        ...
        if (!credential) {
            this.logger.warn(`Credentials not found for provider: ${provider}, loginType: ${loginType}`, this.context);
