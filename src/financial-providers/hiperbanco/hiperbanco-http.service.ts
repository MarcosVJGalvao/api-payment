...
export class HiperbancoHttpService {
    ...
    async get<T>(path: string, options?: HiperbancoRequestOptions): Promise<T> {
        ...
        return executeHiperbancoRequest<T>(
            ...
            headers,
            options?.params,
            () => lastValueFrom(this.httpService.get(this.config.baseUrl + path, { headers, params: options?.params })),
    ...
    async post<T>(path: string, data: Record<string, unknown>, options?: HiperbancoRequestOptions): Promise<T> {
        ...
        return executeHiperbancoRequest<T>(
            ...
            headers,
            data,
            () => lastValueFrom(this.httpService.post(this.config.baseUrl + path, data, { headers })),
            this.getRequestConfig()
        );
    }
    ...
    async put<T>(path: string, data: Record<string, unknown>, options?: HiperbancoRequestOptions): Promise<T> {
        ...
        return executeHiperbancoRequest<T>(
            ...
            headers,
            data,
            () => lastValueFrom(this.httpService.put(this.config.baseUrl + path, data, { headers })),
            this.getRequestConfig()
        );
    }
    ...
    async patch<T>(path: string, data: Record<string, unknown>, options?: HiperbancoRequestOptions): Promise<T> {
        ...
        return executeHiperbancoRequest<T>(
            ...
            headers,
            data,
            () => lastValueFrom(this.httpService.patch(this.config.baseUrl + path, data, { headers })),
            this.getRequestConfig()
        );
    }
