...
import { AccountService, CreateOrUpdateAccountData } from '@/account/account.service';
import { OnboardingService, CreateOrUpdateOnboardingData } from '@/onboarding/onboarding.service';
...
import { HiperbancoAccount, BankLoginUserData } from '../interfaces/hiperbanco-responses.interface';
...
export async function persistAccounts(
    ...
    for (const account of accounts) {
        ...
        const savedAccount = await accountService.createOrUpdate(account.id, clientId, accountData);
 ...
 */
export function parseOnboardingTypeAccount(typeAccount?: 'PF' | 'PJ'): OnboardingTypeAccount {
    return typeAccount === 'PJ' ? OnboardingTypeAccount.PJ : OnboardingTypeAccount.PF;
}
...
export async function persistOnboarding(
    ...
    return onboardingService.createOrUpdate(userData.id, clientId, onboardingData);
}
 ...
 */
export function mapAccountsToResponse(savedAccounts: Account[]): HiperbancoAccount[] {
