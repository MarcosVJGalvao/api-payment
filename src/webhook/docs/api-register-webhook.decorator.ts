    ...
    return applyDecorators(
        ...
        ApiResponse({
            ...
            schema: {
                type: 'object',
                properties: {
                    id: { type: 'string', example: '89444df2-a1d1-4fe8-ade8-3d03de0fd61m' },
                    ...
                    publicKey: { type: 'string', example: '872dc2ed-8bee-40b5-8465-5d2953ba76dp' },
                },
            },
        }),
        ApiResponse({
            ...
            schema: {
                ...
                properties: {
                    ...
                    message: { type: 'string', example: 'Token de autenticação inválido ou expirado' },
                },
            },
        }),
        ApiResponse({
            ...
            schema: {
                ...
                properties: {
                    ...
                    message: { type: 'string', example: 'Esta operação requer autenticação de backoffice' },
                },
            },
        }),
        ApiResponse({
